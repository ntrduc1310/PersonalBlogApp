...
namespace PersonalBlogApp.Services
{
    ...
    public interface IBlogService
    {
        ...
        /// Retrieves a single blog by ID without any associated entities.
        Task<Blog?> GetBlogByIdOnlyAsync(int id);
        /// Creates and saves a new blog post to the database.
        Task<int> CreateBlogAsync(BlogCreateVM model, string userId);
